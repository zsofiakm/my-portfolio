---
title: "Once UI design system with Next.js and Figma"
publishedAt: "2024-04-08"
summary: "Developed a flexible and scalable design system using Next.js for front-end development and Figma for design collaboration."
images:
...
## Building a Customizable Design System with Next.js and Figma

### Overview

In this project, we developed a flexible and scalable design system using Next.js for front-end development and Figma for design collaboration. The goal was to create a reusable component library that not only adheres to consistent design principles but is also easily extendable for future needs. The design system was aimed at improving the overall developer experience while maintaining visual consistency across multiple projects.
...
[Visit Once UI.](http://once-ui.com)